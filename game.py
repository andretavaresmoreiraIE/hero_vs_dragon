...
while True:
    try:
        ...
        print ("give a proper hero a number")
while True:
    try:
...
while True:
    try:
        hero_max_dmg = input ("waht is the damage of the hero?")
...
# here goes the while:
    ...
    # here you need to update the hero hp, you need to subtract the damage that the dragon
    hero_hp=hero_hp-dragon_attack

    # add code on this line

    print ("The dragon does", dragon_attack, "damage and the hero has", hero_hp, "hp lefto")
